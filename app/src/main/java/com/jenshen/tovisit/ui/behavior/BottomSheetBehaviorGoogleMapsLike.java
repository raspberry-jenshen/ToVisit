...
public class BottomSheetBehaviorGoogleMapsLike<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehaviorGoogleMapsLike(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.GoogleMapsSheetBehavior_Params);
        setPeekHeight(a.getDimensionPixelSize(
                R.styleable.GoogleMapsSheetBehavior_Params_googleMaps_behavior_peekHeight, 0));
        setHideable(a.getBoolean(R.styleable.GoogleMapsSheetBehavior_Params_googleMaps_behavior_hideable, false));
        a.recycle();
